...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "rcsousa-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/rcsousa"
  #   chef.validation_client_name = "rcsousa-validator"
  #   chef.validation_key_path = ".chef/rcsousa-validator.pem"
  # end
end
